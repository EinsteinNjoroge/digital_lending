...
@Data
@Schema(name = "ProductConfigurationRequest", description = "Request to create or update a loan product.")
public class ProductConfigurationRequestDto {

    @NotBlank(message = "Product code is required")
    @Size(max = 32)
    @Schema(description = "Product code used by upstream systems.", example = "LN_MZ_MZN_CASH_NANO")
    private String productCode;

    @NotBlank(message = "Product name is required")
    @Size(max = 100)
    @Schema(description = "Human-friendly product name.", example = "Mobile Money Quick Emergency Cash Boost")
    private String name;
    ...
    @Schema(description = "Flexible key-value parameters for the product.", example = "{\"interest_rate_daily\": \"0.0015\", \"grace_period_days\": \"3\"}")
    private Map<String, String> parameters;

    @Schema(description = "Structured document or rule matrices stored as JSON.", example = "{\"UNDERWRITING_CHECKLIST\": {\"minimum_wallet_age_months\": 6, \"require_identity_verification\": true}}")
