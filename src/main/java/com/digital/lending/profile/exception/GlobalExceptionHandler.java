...
@RestControllerAdvice(value = "com.digital.lending.profile", name = "profileExceptionHandler")
public class GlobalExceptionHandler {

    @ExceptionHandler(ProfileDomainException.class)
    public ResponseEntity<ApiErrorResponse> handleProfileDomainExceptions(ProfileDomainException ex) {
    ...
    public ResponseEntity<ApiErrorResponse> handleHttpMessageNotReadable(
        ...
        String userFriendlyMessage = "Invalid input format. Check your enum values (e.g., profileType, documentType).";
